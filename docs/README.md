...
- `apps/api` : sondes de santé, API IAM du LOT 4 et annuaires du LOT 5 ;
...
enseignants et les relations parent/enfant. Les autres écrans restent en mocks : aucun LOT 6,
