...
- `apps/api` : sondes de santé, IAM LOT 4, annuaires LOT 5, référentiel académique LOT 6, inscriptions LOT 7 et Finance LOT 8 ;
...
connecte les frais, factures, paiements, reçus métier et sessions de caisse. Les autres écrans
restent en mocks : aucun LOT 9, paiement en ligne, PDF/QR final, file de travaux,
connecteur d'envoi ou calcul de notes n'est implémenté. Consultez
