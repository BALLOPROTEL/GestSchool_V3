...
- `apps/api` : sondes de santé, API IAM du LOT 4, annuaires du LOT 5 et référentiel académique du LOT 6 ;
...
affectations enseignants. Les autres écrans restent en mocks : aucun LOT 7,
